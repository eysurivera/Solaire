...
<option value="<?php echo htmlentities($row->ID);?>"><?php echo htmlentities($row->CategoryName);?></option>
 ...
 <?php } ?> 
                                                    ...
                                                    <div class="form-group"> <label for="exampleInputEmail1">No. of Adults</label> <input type="text" class="form-control" name="maxadult" value="" required='true'> </div>

                                                    <div class="form-group"> <label for="exampleInputEmail1">No. of Children</label> <input type="text" class="form-control" name="maxchild" value="" required='true'> </div>
