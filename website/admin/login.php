...
<body>
	...
	<p style="padding-top: 20px;padding-left: 20px"><a style="color:#a58f7c;"href="../index.php">go to junnel's hotel landing page</a></p>
		 ...
		 <!-- Form -->
			...
			<form method="post">
				...
				<div>
					...
					<input style="background-color: #a58f7c; width:100px;font-weight:bold;"type="submit" value="sign in" name="login">
